...
class EworldAccelerator_AjaxDynamicContent_Model_System {
    /** @var bool $dropBefore */
    private $dropBefore;
    /** @var EworldAccelerator_AjaxDynamicContent_Model_Selector[] $selectorList */
    ...
    /**
     * @param EworldAccelerator_AjaxDynamicContent_Model_Selector $selector
     * @return bool
     */
    public function addSelector($selector) {
        if (is_object($selector) && is_a($selector, 'EworldAccelerator_AjaxDynamicContent_Model_Selector')) {
    ...
    public function generateJSON()
    {
        ...
        if ($content !== false) {
            if (file_put_contents(self::getJsonFilename(), $content, LOCK_EX) !== false) {
                return true;
            }
        }
    ...
    private static function getJsonFilename() {
        return Mage::getBaseDir().'/js/EworldAccelerator/AjaxDynamicContent/ajaxDynamicContent.json';
    }
}